...
class GetChatApp {
	...
	hideChatBox() {
		//document.getElementById('gcaMainCard').style.display = 'none';
		document.getElementById('gcaMainCard').classList.remove('gcaDisplay');
		this.showHoverBox();
		
	}
	showChatBox() {
		//document.getElementById('gcaMainCard').style.display = 'block';
		if (this.displayBox) {
			document.getElementById('gcaMainCard').classList.add('gcaDisplay');
			this.hideHoverBox();
			setTimeout(function(){ 
				document.getElementById('gcaMainCardInnerChatBoxTextArea').focus();
			}, 700);
		}
	...
	createElementsPro() { return false; }
	hideHoverBox() { return false; }
	showHoverBox() { return false; }
	...
	createElements(data) {
		...
		gcaMainButton.addEventListener('mouseover', () => { 
		...
		gcaMainCardInnerChatBoxSend.addEventListener('click', () => { 
		   this.sendMessage(gcaMainCardInnerChatBoxTextArea.value); 
		}, false);
